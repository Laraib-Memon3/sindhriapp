...
class ProfilePage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          _buildTextField(label: "Delivery address", value: "123 Main St Apartment 4A,New York, NY"),
          _buildTextField(label: "Password", value: "••••••••", icon: Icons.lock),
  ...
  Widget _buildTextField({required String label, required String value, IconData? icon}) {
    return Padding(
